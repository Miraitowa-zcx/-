  ...
  <div style="height: 100vh; overflow: hidden; position: relative;" class="background">
    ...
    <el-row :style="{opacity: 0.8}">
      <div style="width: 500px; height: 450px; background-color: white; border-radius: 10px;
        ...
        <div style="margin: 30px; text-align: center; font-size: 30px; font-weight: bold; color: dodgerblue;">注 册
        </div>
        <el-form :model="admin" :rules="rules" ref="registerForm" label-width="80px">
          ...
          <el-form-item prop="password" label="密码">
            <el-input placeholder="请输入密码" show-password prefix-icon="el-icon-lock" size="medium"
                      v-model="admin.password" type="password"></el-input>
          </el-form-item>
          <el-form-item prop="repeatPassword" label="确认密码">
            <el-input placeholder="请输入确认密码" show-password prefix-icon="el-icon-lock" size="medium"
                      v-model="admin.repeatPassword" type="password"></el-input>
          </el-form-item>
